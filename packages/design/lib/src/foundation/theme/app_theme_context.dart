...
import 'package:design/src/foundation/theme/toast_message_theme.dart' show AppToastMessageTheme;
...
extension BuildContextExt on BuildContext {
  ...
  AppToastMessageTheme get toastMessageTheme => Theme.of(this).extension<AppToastMessageTheme>()!;

  AppButtonTheme get buttonTheme => Theme.of(this).extension<AppButtonTheme>()!;

  AppTextFieldTheme get textFieldTheme => Theme.of(this).extension<AppTextFieldTheme>()!;
}
